...
pattern ScancodeAudioNext = Scancode Raw.SDL_SCANCODE_MEDIA_NEXT_TRACK
pattern ScancodeAudioPrev = Scancode Raw.SDL_SCANCODE_MEDIA_PREVIOUS_TRACK
...
pattern KeycodeQuoteDbl = Keycode Raw.SDLK_DBLAPOSTROPHE
...
pattern KeycodeQuote = Keycode Raw.SDLK_APOSTROPHE
...
pattern KeycodeBackquote = Keycode Raw.SDLK_GRAVE
...
pattern KeycodeAudioNext = Keycode Raw.SDLK_MEDIA_NEXT_TRACK
pattern KeycodeAudioPrev = Keycode Raw.SDLK_MEDIA_PREVIOUS_TRACK
pattern KeycodeAudioStop = Keycode Raw.SDLK_MEDIA_STOP
